...
#define _________________NUMBER_L2_________________ LSFT_T(KC_MINS),   LCTL_T(KC_4),    LALT_T(KC_5),     LGUI_T(KC_6),     KC_EQL
#define _________________NUMBER_L3_________________          KC_GRV,   KC_1        ,            KC_2,             KC_3,     KC_BSLS

#define _NUML1_ KC_DOT
#define ______NUML2_____ KC_0, KC_COMM
...
#define _________________SYMBOL_L2_________________ KC_UNDS ,   KC_DLR,    KC_PERC,     KC_CIRC,     KC_PLUS
#define _________________SYMBOL_L3_________________ KC_TILDE,   KC_EXLM,   KC_AT  ,     KC_HASH,     KC_PIPE

#define _SYML1_ KC_LABK
#define ______SYML2_____ KC_LPRN, KC_RPRN
